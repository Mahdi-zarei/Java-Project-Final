...
public class Pekka extends Character{
    ...
    public Pekka(Circle place) {
        ...
        isBuilding=false;
        Place=place;
        img=new Image("file:character_0012.png");
        Attack=new Image("file:character_0013.png");
        DeathSound=new Media(new File("Death.mp3").toURI().toString());
        DeploySound=new Media(new File("Deploy.mp3").toURI().toString());
        AttackSound=new Media(new File("PekkaAttack.mp3").toURI().toString());
